        ...
        <div class="col-span-2">
            <x-utils.card-grid>
                <form action="{{ route('user.update') }}" method="post" class="card-body" enctype="multipart/form-data">
                    ...
                    <button class="btn btn-primary mt-4"><i class="fa-solid fa-pen me-2"></i>Update my account</button>

                    <!-- Open delete modal -->
                    <label for="delete-modal" class="btn btn-error"><i class="fa-solid fa-trash me-2"></i>Delete
                        account</label>
